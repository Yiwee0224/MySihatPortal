...
@section('content')
            ...
            <table style="width:100%; margin-left:auto; margin-right:auto;  border:1px solid white;">
                <tr>
                    <td>
                        ...
                        <h3 style="margin-top:20px;font-size:30px;">User List</h3>
                    </td>
                </tr>
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td> <a href="/ManageCustomerInfo/CusProfile/{{ $data->userID }}"><button
                                                    type="button"
                                        ...
                                        <td> <a href="/ManageCustomerInfo/UpdateCus/{{ $data->userID }}"><button
                                                    type="button"
                    ...
                    <td>
                        <div style="margin-top:5px;">
                            <div style="float:left;">
                                ...
                                <a href="/ManageCustomerInfo/newCus" type="button"
    ...
    <div class="container-fluid mt-3" style="width:85%; margin-top:20px;">
        <p style="display:inline-block; font-size:16px;">
            ...
            <span style="margin-left:30px;">Total Customer: {{ $customer }}</span>


            <span style="margin-left:30px;">Total admin: {{ $admin }}</span>
        </p>
    </div>
@endsection
